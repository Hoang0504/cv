...
import eduticImage from "../assets/img/projects/edutic.png";
...
const projects = [
  ...
  {
    name: "Edutic: Nền tảng ôn luyện TOEIC tích hợp AI",
    image: eduticImage, // Thay bằng đường dẫn hình ảnh thực tế
    description:
      "Dự án xây dựng nền tảng học tập trực tuyến ôn luyện TOEIC thông minh, tích hợp trí tuệ nhân tạo (AI) nhằm cá nhân hóa lộ trình học, gợi ý tài liệu và hỗ trợ đánh giá năng lực. Hệ thống được phát triển với Next.js cho cả frontend và backend, đảm bảo trải nghiệm hiện đại, trực quan và hiệu quả cho người học.",
    objectives: [
      "Nâng cao kiến thức chuyên môn trong quá trình xây dựng nền tảng học tập trực tuyến tích hợp AI.",
      "Hiểu và vận dụng hiệu quả MySQL trong thiết kế và quản lý cơ sở dữ liệu.",
      "Tích hợp thư viện, API và các công cụ AI phục vụ đánh giá, tư vấn và gợi ý lộ trình học TOEIC thông minh.",
      "Học hỏi và áp dụng quy trình phát triển phần mềm từ phân tích đến triển khai thực tế.",
      "Tối ưu trải nghiệm người dùng thông qua giao diện trực quan, hiệu suất cao và cá nhân hóa.",
    ],
    position: "Leader - Đồ án tốt nghiệp tại Aptech",
    features: [
      "Cá nhân hóa lộ trình học tập dựa trên trình độ và mục tiêu của từng người dùng.",
      "Ngân hàng câu hỏi TOEIC phong phú với nhiều dạng đề sát thực tế.",
      "Chấm điểm và phân tích kết quả tự động, đưa ra nhận xét chi tiết cho từng phần thi.",
      "Gợi ý tài liệu và bài tập phù hợp bằng AI.",
      "Bảng xếp hạng, thành tích và hệ thống theo dõi tiến độ học tập.",
      "Hỗ trợ đa nền tảng: máy tính, máy tính bảng và điện thoại di động.",
    ],
    techStack: [
      "Next.js",
      "TypeScript",
    ...
    githubLink: "https://github.com/Hoang0504/Edutic.git", // Thêm link GitHub repo
    youtubeLink: "https://youtu.be/7OjTrz4DBZ8", // Nếu có video demo
    time: "1 tháng",
  },
];
